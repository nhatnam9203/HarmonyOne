...
const animatedHook = () => {
    const bottomAnimated = React.useRef(new Animated.Value(scaleHeight(1.5))).current;
    const fontSizeAnimated = React.useRef(new Animated.Value(scaleWidth(4.5))).current;
