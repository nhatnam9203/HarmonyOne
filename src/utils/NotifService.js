...
export default class NotifService {
  ...
  localNotif(soundName, appointment = {}) {
    ...
    const time = appointment.FromTime
      ? moment(appointment.FromTime).format("hh:mm A MM/DD/YYYY")
    ...
    PushNotification.localNotification({
      ...
      title: "You have an new appointment!", // (optional)
  ...
  resetBadgeNumber() {
    this.lastId--;
    PushNotification.setApplicationIconBadgeNumber(this.lastId);
  }
