...
import { ActivityIndicator, Platform, View, TouchableOpacity, Image , Text } from 'react-native';
...
class CalendarHeader extends Component {
  ...
  renderWeekDays = weekDaysNames => {
    ...
    return weekDaysNames.map((day, idx) => {
      ...
      return (
        <Text fontFamily='medium' allowFontScaling={false} key={idx} style={dayStyle} numberOfLines={1} accessibilityLabel={''}>
