...
export class Slider extends PureComponent {
  ...
  render() {
    ...
    var { value, containerSize, trackSize, thumbSize, allMeasured } =
      this.state;
    ...
    return (
      ...
      >
        ...
        >
          {this.props.smsCount != "0" &&
            this.props.smsCount != this.props.smsMaxCount && (
              <View
                style={{
                  position: "absolute",
                  top: -scaleWidth(45),
                  ...
                  left: scaleWidth(
                    this.getLeftPositionOfCount(this.props.smsCount)
                  ),
                }}
              >
                <Text
          ...
          {formatNumberFromCurrency(this.props.smsMoney) != 0 &&
            formatNumberFromCurrency(this.props.smsMoney) !=
              formatNumberFromCurrency(this.props.smsMaxMoney) && (
              <View
                style={{
                  position: "absolute",
                  top: scaleWidth(56),
