...
export const DataList = ({
    ...
    const onRowPress = ({ item, row }) => {
        NavigationService.navigate(screenNames.GiftCardStatistic, { item, dataList: data, timeStart, timeEnd, });
    }
    ...
    return (
        <CustomTable
            tableData={data}
            tableHead={{
                cardType: translate("Type"),
                quantity: translate("Qty sold"),
                sales: translate("Net sales")
            }}
            whiteKeys={[
                "cardType",
                "quantity",
